...
In Matlab the function CWT can be used to compute the continuous wavelet transformation by inserting the signal and the sampling frequency. This will give a scolargram as shown in  \figref{fig:scolargram}. \cite{mathworks2017} 
...
% An example of a scalorgram is given in \figref{fig:scolargram}
