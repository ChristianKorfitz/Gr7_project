...
In Matlab the function CWT can be used to compute the continuous wavelet transformation by inserting the signal and the sampling frequency. This will give a scalogram as shown in  \figref{fig:scalogram}. \cite{mathworks2017} 
