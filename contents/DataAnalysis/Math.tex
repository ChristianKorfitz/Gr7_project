...
Additionally there is also a drift occurring within each interval between two jumps, which hampers the correct data analysis.% this can also be seen in figure \ref{fig:scalogram_uncorr} as the frequency band with higher magnitude. 
