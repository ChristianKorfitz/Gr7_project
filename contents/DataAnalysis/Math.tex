...
\begin{figure}[H]
	...
	\caption{Scalogram from the original data of region 24 in the cuffed recording of subject 1, where high spike magnitudes can be seen induced by the jumps.}
