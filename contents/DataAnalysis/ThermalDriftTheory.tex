...
\label{sec:artifacts}
Because of the data seen in figure \figref{fig:Intensities}, a representation natural temperature variation is ruled out. Therefore it is assumed that the greater shifts is due to a technological limit.\fxnote{because of the systematic change in all regions} Because of this assumption, it is chosen to further investigate the buildup of thermal cameras and look into other papers, to see if they hat encountered same difficulties.
