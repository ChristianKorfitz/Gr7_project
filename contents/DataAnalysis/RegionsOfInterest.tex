...
The original image on \figref{fig:hand} is showing the hand but not with very good contrast. To easier choose ROI, the original image was converted to a gray scale image to improve the contrast in the image, this can be seen in \figref{fig:mat2grayHand}. 
...
An example of the pixel intensities for subject 1 is shown on figure \figref{fig:Intensities}.

\begin{figure}[H]
	\includegraphics[width=1.2\textwidth]{figures/Intensities}  %<--but is not needed.
