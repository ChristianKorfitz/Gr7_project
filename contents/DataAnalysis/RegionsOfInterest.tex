...
The original image on \figref{fig:hand} is showing the hand but not with very good contrast. To easier choose ROIs, the original image was converted to a gray scale image to improve the contrast in the image, this can be seen in \figref{fig:mat2grayHand}. 
