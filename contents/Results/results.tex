...
\begin{table}[H]
	...
	\begin{tabular}{|l|l|l|l|}
		...
		\textbf{ROI 20} & 0.4141 & 0.8494 & 0.8004  \\ \hline
		\textbf{ROI 21} & 0.4062 & 0.9564 & 0.8452  \\ \hline
		\textbf{ROI 22} & 0.3826 & 0.9323 & 0.1552  \\ \hline
	\end{tabular}}
	\label{my:pval}
\end{table}
As indicated in table \ref{my:pval}, all of the tests show a significance level well above 0.05, which means that $h_{0}$ is not rejected, whereby there is no difference between the two conditions. %The lowest p-value is presented in region 22 where a p-value of 0.1552 for the neurogenic band is found. 
