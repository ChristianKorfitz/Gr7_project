\chapter{Results}
\textit{In this chapter the results on behalf of the data analysis will be shown. A paired t-test of the mean magnitude for each frequency band specified in section \ref{sec:thermalImaging} is computed to test the likelihood of finding a difference between the uncuffed and cuffed conditions.}
