...
The infrared radiation is detected as an analogue signal by the FPA. An AD-converter prepares the signal for the processor module in the thermal camera. The signal is modified into pixels, what gives an digital image as an output, which contains the temperature informations of the observed object. A schematic representation of this is illustrated on figure \ref{fig:em_spectrum}. \cite{optris2009,ignacio2017}

\begin{figure}[H]                                         
	\includegraphics[width=.55\textwidth]{figures/IR_cam}  
	\caption{Simplified block diagram of an standard thermal detector.\cite{optris2009}}
