...
The infrared radiation is detected as an analogue signal by the FPA. An AD-converter prepares the signal for the processor module in the thermal camera. The signal is modified into pixels, what gives a digital image as an output, which contains the temperature informations of the observed object. A schematic representation of a thermal detector is illustrated on figure \ref{fig:em_spectrum}.\cite{ignacio2017,optris2009}
